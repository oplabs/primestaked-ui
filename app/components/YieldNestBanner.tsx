  ...
  return (
    <div className="flex flex-col align-middle bg-black py-16 px-8">
      <div className="flex flex-row items-center justify-center pb-8">
        <img className="w-[120px]" alt="primeETH" src={Logo} />
        <img
      ...
      <div className="flex flex-row justify-center gap-8 px-28">
        <a
          href="https://www.yieldnest.finance/"
          target="_blank"
          rel="noopener noreferrer"
          className="block sm:inline text-center sm:w-auto btn sm:px-20 py-5 text-lg hover:cursor-pointer"
        >
          Learn more
        </a>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="block sm:inline text-center sm:w-auto btn-alert sm:px-20 py-5 text-lg hover:cursor-pointer"
        >
          Visit YieldNest
        </a>
      </div>
...
const Card = ({ icon, description, title }: CardProps) => {
  return (
    <div className="flex flex-col align-middle p-5 border border-gray-750 rounded-xl bg-gray-850 bg-opacity-50 gap-2 w-full md:w-[300px]">
      <img className="w-[70px] h-[70px] mx-auto" alt={title} src={icon} />
